...
public class ApiClient {
    ...
    private String basePath = "https://api.originstamp.org";
    ...
    public ApiClient() {
        ...
        setUserAgent("OriginStamp Client Java");

        // Setup authentications (key: authentication name, value: authentication).
        authentications = new HashMap<String, Authentication>();
        authentications.put("Enterprise Key Authorization", new ApiKeyAuth("header", "Authorization"));
        authentications.put("System Key Authorization", new ApiKeyAuth("header", "Authorization"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.originstamp.org
