...
public class SchedulerResponse {
  ...
  **/
  @ApiModelProperty(value = "Next submission time. The date is returned in the following format: [ms] since 1.1.1970 (unix epoch), timezone: UTC. The timezone is UTC.")
