...
public class SchedulerControllerApiTest {
     ...
     */
    @Test
    public void getSchedulerInformationUsingPOSTTest() throws ApiException {
        SchedulerInformationRequestDTO requestDTO = null;
        ServiceResponseSchedulerInformationResponseDTO response = api.getSchedulerInformationUsingPOST(requestDTO);
